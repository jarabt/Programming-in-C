# PROSBA O POMOC!
Prosím informujte mě (ticketem nebo pomocí pull) jestli znáte nějaké dobré odkazy na :
* **Programování Hardware firmware**
* **Qemu/KVM hypervisor**
* **kernel network stack**

----
* [Univerzita nízkoúrovňového programování](#Univerzita-nízkoúrovňového- programování)
  * [Co to je?](#What-is-it)
  ...
  * [Aplikace](#Applications)
    ...
    * [Linuxové jádro and obsluhovač zařízení](#Linux-kernel-and-device-driver)
